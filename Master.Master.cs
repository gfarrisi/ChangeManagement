...
namespace ChangeManagementSystem
{
    public partial class Master : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //commented stuff out below because we dont have "lbl_User" control in master
            //if (Session["Full_Name"] != null)
            //{
            //    lbl_User.Text = "Logged in as: " + Session["Full_Name"].ToString();
            //}
            //else
        ...
        // changed to pre-stem link
        /*Navigation Methods*/
        protected void lb_Logout_Click(object sender, EventArgs e)
        {
            Response.Redirect("https://pre-stem.temple.edu/Shibboleth.sso/Logout?return=https://pre-stem.temple.edu/idp/profile/Logout");
        }
    }
}